  ...
  return (
    <div>
      ...
      <section className="icons-container">
        ...
        <div className="icons">
          <i className="fa-solid fa-music icons_for-bookhub"></i>
          <div className="feature-content">
            <h3 className="port-shipping">Lyrics Detection</h3>
            <p className="facility_for-port">Detects lyrics mood</p>
          </div>
        </div>
        <div className="icons">
          <i className="fa-solid fa-headphones icons_for-bookhub"></i>
          <div className="feature-content">
            <h3 className="port-shipping">Audio Detection</h3>
            <p className="facility_for-port">Detects Audio mood</p>
          </div>
        </div>
      </section>
    </div>
